...
export const Icons = [
  ...
  { name: 'email', path: `${IconsPath}/mail.svg` },
  ...
  { name: 'phone', path: `${IconsPath}/phone.svg` },
  ...
  { name: 'keyboard', path: `${IconsPath}/keyboard.svg` },
  { name: 'rwd', path: `${IconsPath}/rwd.svg` },
  { name: 'team', path: `${IconsPath}/team.svg` },
  { name: 'arch', path: `${IconsPath}/settings_arch.svg` },
  { name: 'tick', path: `${IconsPath}/tick.svg` }
]
